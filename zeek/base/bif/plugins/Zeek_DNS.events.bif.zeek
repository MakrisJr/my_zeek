...
global dns_HINFO_reply: event(c: connection , msg: dns_msg , ans: dns_answer ) &deprecated="Remove in v5.2. Use the definition with the extra parameters for cpu and os.";
