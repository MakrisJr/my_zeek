...
global analyzer_confirmation: event(c: connection , atype: AllAnalyzers::Tag , aid: count ) &deprecated="Remove in 6.1. Use the generic analyzer_confirmation_info event instead.";
...
##    engine.
global analyzer_violation: event(c: connection , atype: AllAnalyzers::Tag , aid: count , reason: string ) &deprecated="Remove in 6.1. Use the generic analyzer_violation_info event instead.";
